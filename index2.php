...
- мне не нравится, как реаизовад метод getTaxonomy(), поттому что нет класса ОВОЩИ аналогичного fruit
- я делал некоторые методы класса Plant со свойствами protected. Но потом переделал на public,
чтобы в производных классах не булировать все говно, т.к. не видел смысла переопределять методы родительские */
class Plant{
...
// Примеры реализации объектов классов:
// Объект "картоха"
